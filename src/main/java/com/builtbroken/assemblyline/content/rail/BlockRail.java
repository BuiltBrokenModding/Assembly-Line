...
public class BlockRail extends Block implements ITransportRailBlock
{
    ...
    @Override
    public void tickRailFromCart(ITransportCart cart, World world, int x, int y, int z, int meta)
    {
        //Nothing to do
    }

    @Override
    public boolean isUsableRail(World world, int x, int y, int z, int meta)
    {
        return true;
    }

    @Override
    public ForgeDirection getAttachedDirection(World world, int x, int y, int z, int meta)
    {
        return RailDirections.get(meta).side;
    }

    @Override
    public ForgeDirection getFacingDirection(World world, int x, int y, int z, int meta)
    {
        return RailDirections.get(meta).facing;
    }

    @Override
    public float getRailHeight(World world, int x, int y, int z, int meta)
    {
        return RAIL_HEIGHT;
    }
