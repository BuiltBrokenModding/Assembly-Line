...
public class TilePowerRailClient extends TilePowerRail
{
    ...
    public void registerIcons(IIconRegister iconRegister)
    {
        ...
        main = iconRegister.registerIcon(AssemblyLine.PREFIX + "PowerRailBody");
        ...
        for (int i = 0; i < sideName.length; i++)
        {
            ...
            {
                arrow[i][y] = iconRegister.registerIcon(AssemblyLine.PREFIX + "PowerRailArrow" + sideName[i] + textureNames[y]);
            }
        }
    }
    ...
    {
        return new ItemStack(AssemblyLine.blockPowerRail, 1, railType.ordinal());
    }
